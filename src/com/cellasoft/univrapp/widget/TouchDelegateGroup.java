...
public class TouchDelegateGroup extends TouchDelegate {
	 ...
	 * 
	 * @param uselessHackyView
	 *            A non-null {@link View} that will have no effect on the newly
	 *            created {@link TouchDelegateGroup}. As a result you can pass
	 *            any {@link View} instance you want as long as it is not null.
	 */
	 ...
	 * 
	 * @param bounds
	 *            Bounds in local coordinates of the containing view that should
	 *            be mapped to the delegate view
	 * @param delegateView
	 ...
	 * 
	 * @param touchDelegate
	 *            The {@link TouchDelegate} to remove in this
