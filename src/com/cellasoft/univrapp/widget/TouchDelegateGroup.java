...
public class TouchDelegateGroup extends TouchDelegate {
     ...
     *
     * @param uselessHackyView A non-null {@link View} that will have no effect on the newly
     ...
     *
     * @param bounds       Bounds in local coordinates of the containing view that should
